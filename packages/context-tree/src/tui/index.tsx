    ...
    commands: [
      {
        ...
        name: "ctree.open",
        title: "Context tree",
        description: "See where your context went, and jump anywhere in it",
        category: "Context",
        slashName: "tree",
      ...
      },
      {
        ...
        name: "ctree.branch",
        title: "Branch here",
        description: "Try something risky on a copy — this session keeps its context either way",
        category: "Context",
        slashName: "branch",
      ...
      },
      {
        ...
        description: "Mark this message so you can find it again in the tree",
        category: "Context",
        slashName: "label",
        enabled: () => Boolean(currentSession(api)),
        run: detached(async () => {
    ...
    commands: [
      {
        ...
        name: "ctree.merge",
        title: "Merge branch",
        description: "End this branch: land one ◆ record of what you concluded, not the noise",
        category: "Context",
        slashName: "merge",
        enabled: () => Boolean(currentSession(api)),
        run: detached(async () => {
      ...
      },
      {
        ...
        title: "Decisions",
        description: "Every ◆ record this tree has confirmed — jump to one, or export them",
        category: "Context",
        slashName: "decisions",
        run: () => {
          const sessionID = currentSession(api)
